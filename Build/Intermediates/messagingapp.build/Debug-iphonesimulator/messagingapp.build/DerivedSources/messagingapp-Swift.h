...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="messagingapp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12messagingapp11AppDelegate")
...
SWIFT_CLASS("_TtC12messagingapp21ComposeViewController")
...
SWIFT_CLASS("_TtC12messagingapp19LoginViewController")
...
- (void)viewDidLoad;
- (IBAction)signInSelectionChanged:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC12messagingapp13SceneDelegate")
...
SWIFT_CLASS("_TtC12messagingapp14ViewController")
